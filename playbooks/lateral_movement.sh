#!/bin/bash
# Lateral Movement Playbook - ENHANCED with full output
# ======================================================
# STANDALONE — does NOT require any prior playbook to run
# Shows RDP status, SMB shares, file transfer results
...
main() {
    echo ""
    echo "╔══════════════════════════════════════════════════════════════╗"
    echo "║         Lateral Movement Attack Playbook                     ║"
    ...
    echo ""
    echo "╔══════════════════════════════════════════════════════════════╗"
    echo "║           EXECUTING LATERAL MOVEMENT ATTACKS                 ║"
    echo "╚══════════════════════════════════════════════════════════════╝"

    execute_and_show "T1021.001" "RDP — Enumerate RDP service & registry"
    execute_and_show "T1021.002" "SMB/Admin Shares — List accessible shares"
    execute_and_show "T1570"     "Lateral Tool Transfer — Test file transfer"
    ...
    log_success "Lateral Movement playbook completed!"
    echo ""
}
